...
var dummyMakrs = [
    ChargeStnAnnotation(coordinate: dummyChargeStationData[0].coordinate,
                        stnId: dummyChargeStationData[0].id,
                        title: dummyChargeStationData[0].stnPlace,
                        subtitle: dummyChargeStationData[0].stnAddr),
    ChargeStnAnnotation(coordinate: dummyChargeStationData[1].coordinate,
                        stnId: dummyChargeStationData[1].id,
                        title: dummyChargeStationData[1].stnPlace,
                        subtitle: dummyChargeStationData[1].stnAddr),
    ChargeStnAnnotation(coordinate: dummyChargeStationData[2].coordinate,
                        stnId: dummyChargeStationData[2].id,
                        title: dummyChargeStationData[2].stnPlace,
                        subtitle: dummyChargeStationData[2].stnAddr),
    ChargeStnAnnotation(coordinate: dummyChargeStationData[3].coordinate,
                        stnId: dummyChargeStationData[3].id,
                        title: dummyChargeStationData[3].stnPlace,
                        subtitle: dummyChargeStationData[3].stnAddr),
    ChargeStnAnnotation(coordinate: dummyChargeStationData[4].coordinate,
                        stnId: dummyChargeStationData[4].id,
                        title: dummyChargeStationData[4].stnPlace,
                        subtitle: dummyChargeStationData[4].stnAddr),
    ChargeStnAnnotation(coordinate: dummyChargeStationData[5].coordinate,
                        stnId: dummyChargeStationData[5].id,
                        title: dummyChargeStationData[5].stnPlace,
                        subtitle: dummyChargeStationData[5].stnAddr)
]
